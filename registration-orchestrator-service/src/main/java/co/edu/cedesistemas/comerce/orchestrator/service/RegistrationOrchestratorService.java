package co.edu.cedesistemas.comerce.orchestrator.service;

import co.edu.cedesistemas.comerce.orchestrator.client.CommerceServiceClient;
import co.edu.cedesistemas.comerce.orchestrator.client.LoyaltyServiceClient;
import co.edu.cedesistemas.comerce.orchestrator.client.RegistrationServiceClient;
import co.edu.cedesistemas.comerce.orchestrator.client.SocialServiceClient;
...
public class RegistrationOrchestratorService {
    ...
    public void registerCommerceOrder(Message in) {
        String msg = new String(in.getBody(), StandardCharsets.UTF_8);
