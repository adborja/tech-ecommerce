...
public class UserController {
    ...
    public ResponseEntity<Status<?>> createUserOrder(@RequestBody UserOrder userOrder){
        UserOrder orderCreated = userOrderService.registerOrder(userOrder.getId(), userOrder.getStoreId(),
                userOrder.getUserId(), userOrder.getOrderValue());
        return DefaultResponseBuilder.defaultResponse(orderCreated, HttpStatus.CREATED);
