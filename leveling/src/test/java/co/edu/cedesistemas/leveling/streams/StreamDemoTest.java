    ...
    public void testRectangleStreams() {
        ...
        */
        ...
        List<Rectangle> result = rectangles.stream()
                                    ...
                                    .filter(rectangle -> rectangle.area() <= 150D)
                                    .map(Rectangle::mirror)
                                    .map(rectangle -> {
                                        Rectangle rectangle1 = rectangle.scale(50D);
                                        rectangle1.setBottomLeft(rectangle.getBottomLeft());
                                        return rectangle1;
                                    })
                                    .sorted((o1, o2) -> ((o1.area() <=  o2.area() )? 1 : -1))
