...
public class EventPublisherService {
    ...
    public void publishShipmentEvent(Shipment shipment, ShipmentStatus shipmentStatus) {
        ShipmentEvent event = ShipmentEvent.builder()
                ...
                .reasonCancel((shipment.getCanceledDelivery()!=null ? shipment.getCanceledDelivery().getDescription():null))
                .build();
