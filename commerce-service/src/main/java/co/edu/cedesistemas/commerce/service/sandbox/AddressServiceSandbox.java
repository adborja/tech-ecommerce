...
public class AddressServiceSandbox implements IAddressService {
    ...
    public Address getById(String id) {
        ...
        address.setDescription("Direccion sandbox");
        address.setName("Personal");
        address.setStreet1("Calle 45 AA");
        address.setPhoneNumber("313456789");
        address.setStreet2("#43 sur 20");
        address.setZip("40001");
        return address;
    }
}
